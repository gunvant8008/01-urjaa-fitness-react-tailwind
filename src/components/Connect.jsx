...
const Connect = () => {
  return (
    <div className=" lg:mt-40 md:mt-20 mt-10">
      <div className="flex flex-col  md:gap-10 gap-8 m-auto py-10 max-w-[70vw] justify-center items-center">
        <h1 className=" md:text-5xl text-3xl font-bold text-center">Connect On Youtube For More Educational Content</h1>
