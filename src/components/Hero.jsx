      ...
      <section className="pt-20">
        <div id="home" className="flex flex-col-reverse lg:flex md:gap-20 gap-8 m-auto py-20 lg:flex-row max-w-[70vw] justify-between items-center">
          <div className="flex-1 flex flex-col items-center lg:items-start gap-5 text-center lg:text-left">
            ...
            <PopupButton id="lYnpNrDL" style={{ fontSize: 20 }} className=" text-white bg-black px-8 py-3 rounded-xl hover:bg-yellow-500 hover:text-black transition-all ease-linear duration-100">
              Start Now
            </PopupButton>
          </div>
          <div className="relative overflow-hidden flex-1 shadow-xl shadow-gray-300">
            <img src={mainImg} alt="" />
            <button onClick={() => setOpenModal(true)} className="absolute hover:scale-105 transition-all ease-linear duration-200 -bottom-3 w-full text-sm p-1 font-bold rounded-md bg-yellow-400 left-1/2 transform -translate-x-1/2 -translate-y-1/2  cursor-pointer">
